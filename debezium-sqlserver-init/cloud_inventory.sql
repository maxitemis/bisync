...
-- Create and populate the legacy_products on hand using multiple inserts
CREATE TABLE legacy_products_on_hand (
                                         product_id INTEGER NOT NULL PRIMARY KEY,
                                         quantity INTEGER NOT NULL,
                                         FOREIGN KEY (product_id) REFERENCES legacy_products(id)
);
INSERT INTO legacy_products_on_hand VALUES (101,3);
INSERT INTO legacy_products_on_hand VALUES (102,8);
INSERT INTO legacy_products_on_hand VALUES (103,18);
INSERT INTO legacy_products_on_hand VALUES (104,4);
INSERT INTO legacy_products_on_hand VALUES (105,5);
INSERT INTO legacy_products_on_hand VALUES (106,0);
INSERT INTO legacy_products_on_hand VALUES (107,44);
INSERT INTO legacy_products_on_hand VALUES (108,2);
INSERT INTO legacy_products_on_hand VALUES (109,5);
EXEC sys.sp_cdc_enable_table @source_schema = 'dbo', @source_name = 'legacy_products_on_hand', @role_name = NULL, @supports_net_changes = 0;
